...
const SelectionModal: React.FC<SelectionModalProps> = ({
  ...
  return (
    <div className="sm:w-80 border-gray-500 sm:border-l-2 sm:border-t-0 border-t-2 sm:absolute sm:top-20 sm:right-0 sm:bottom-0 bg-white z-10">
      <div className="flex items-center justify-between sm:pl-10 sm:pb-16 pt-6 sm:pr-10 pr-6 pl-6 pb-8">
        <p className="sm:text-2xl text-xl text-gray-100">{title}</p>
        <svg
          width="14"
          height="14"
          viewBox="0 0 14 14"
      ...
      <div className="sm:absolute sm:bottom-0 sm:right-0 sm:w-80 sm:mt-0 mt-10">
